import { ArrowLeft, Eye, Save, Settings, Smartphone, Monitor } from 'lucide-react';
...
export function EditorToolbar({ setShowProperties, showProperties }: EditorToolbarProps) {
  return (
    <div className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 px-6 py-4 flex items-center justify-between shadow-sm">
      <div className="flex items-center gap-4">
        ...
        <div>
          <p className="text-sm text-gray-900 dark:text-white">Untitled Page</p>
          <p className="text-xs text-gray-500 dark:text-gray-400">Last saved 2 minutes ago</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <Button
          ...
          className={`rounded-xl ${showProperties ? 'bg-gray-100 dark:bg-gray-800' : ''}`}
        >
        ...
        <Button size="sm" className="gap-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-600 dark:hover:bg-indigo-700 shadow-md shadow-indigo-500/20">
